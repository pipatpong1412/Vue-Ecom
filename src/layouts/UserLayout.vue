...
<template>
    ...
    <div class="container mx-auto">
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{ name: 'home' }" class="btn btn-ghost text-xl font-bold">ViewShop</RouterLink>
            </div>
            <div class="flex-none gap-2">
                <div class="form-control">
                    <input @keyup="hdlSearch" v-model="searchText" type="text" placeholder="Search"
